    ...
    <div className="sticky top-0 z-50 mx-auto flex max-w-7xl flex-col gap-4 rounded-b-2xl border border-white/10 bg-[#050816]/80 px-5 py-4 backdrop-blur-xl transition-colors duration-300 md:flex-row md:items-center md:justify-between md:px-8">
      <div className="flex w-full items-center justify-between md:w-auto">
        ...
        <button
          type="button"
          onClick={toggleTheme}
          className="theme-toggle-btn grid h-11 w-11 shrink-0 place-items-center rounded-xl border border-white/10 bg-white/5 transition hover:-translate-y-1 hover:border-cyan-400 hover:text-cyan-400 md:hidden"
      ...
      <div className="flex w-full items-center justify-between gap-4 md:w-auto">
        ...
        <button
          type="button"
          onClick={toggleTheme}
          className="theme-toggle-btn hidden h-11 w-11 shrink-0 place-items-center rounded-xl border border-white/10 bg-white/5 transition hover:-translate-y-1 hover:border-cyan-400 hover:text-cyan-400 md:grid"
          aria-label="Toggle theme"
        >
          {theme === "dark" ? (
            <svg
